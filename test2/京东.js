        ...
        off: function(t, e, n) {
            ...
            if (r = this.callbacks) {
                ...
                for (t = t ? t.split(c) : o.keys(r); i = t.shift(); )
                    ...
                    delete r[i],
                    s && (e || n))
                        for (a = s.tail; (s = s.next) !== a; )
                            l = s.callback,
                            f = s.context,
                            (e && l !== e || n && f !== n) && this.on(i, l, f);
                return this
            }
        },
        trigger: function(t) {
            ...
            for (a = i.all,
            t = t.split(c),
            l = r.call(arguments, 1); e = t.shift(); ) {
                if (n = i[e])
                    for (o = n.tail; (n = n.next) !== o; )
                        n.callback.apply(n.context || this, l);
                if (n = a)
                    for (o = n.tail,
                    s = [e].concat(l); (n = n.next) !== o; )
                        n.callback.apply(n.context || this, s)
            }
            return this
        }
    },
    ...
    (function(t, r) {
        !function(t, n) {
            ...
            function handleMaybeThenable(e, t, n) {
                t.constructor === e.constructor && n === then && t.constructor.resolve === resolve$1 ? handleOwnThenable(e, t) : n === C ? (reject(e, C.error),
                C.error = null) : n === undefined ? fulfill(e, t) : isFunction(n) ? handleForeignThenable(e, t, n) : fulfill(e, t)
            }
            ...
            function fulfill(e, t) {
                e._state === y && (e._result = t,
                e._state = g,
                0 !== e._subscribers.length && u(publish, e))
            }
            function reject(e, t) {
                e._state === y && (e._state = b,
                e._result = t,
    ...
    (function(t) {
        !function(t, n) {
            ...
            function jsonp$1(e, t, n) {
                if (isFunction(e) ? (n = e,
                t = {}) : e && "object" === (void 0 === e ? "undefined" : l(e)) && (n = t,
                t = e || {},
                e = t.url),
                isFunction(t) && (n = t,
                t = {}),
...
, function(e, t, n) {
    ...
    function attachEvent(e, t, n) {
        if ((t = fixEvent(e, t)) === _)
            return void processOnPropertyChangeEvent(e, n);
        var r = w.get(t);
        if (1 === x[t]) {
            r || (r = new m);
            ...
            r.event = attachEventToDocument(s, t, r),
            w.set(t, r)),
            isFunction(n) && (k && (e.onclick = noop$1),
            r.items.set(e, n))
    }
    function detachEvent(e, t, n) {
        if ((t = fixEvent(e, t)) !== _) {
            ...
            if (1 === x[t] && r) {
                ...
                var a = r.items;
                a["delete"](e) && 0 === a.size && (s.removeEventListener(parseEventName(t), r.event, !1),
                w["delete"](t))
            }
        }
    }
    ...
    function unbindOnPropertyChange() {
        N && (delete N.value,
        N.removeEventListener("propertychange", propertyChangeHandler, !1),
        N = null,
        O = null,
        P = null)
    }
    ...
    function patch(e, t, n, r, o) {
        ...
        if (isSameVNode(e, t)) {
            var s = t.vtype;
            if (2 & s)
                o = isNullOrUndef(o) ? e.isSvg : o,
                o && (t.isSvg = o),
                patchProps(a, t.props, e.props, e, o),
                patchChildren(a, e.children, t.children, r, o),
                null !== t.ref && b.update(e, t, a),
                i = a;
            else if ((12 & s) > 0)
                i = t.update(e, t, r),
                A.afterUpdate(t);
    ...
    function patchArrayChildren(e, t, n, r, o) {
        ...
        if (0 === i) {
            ...
            e.textContent = "") : isKeyed(t, n) ? patchKeyedChildren(t, n, e, r, o, i, a) : patchNonKeyedChildren(e, t, n, r, o, i, a)
    }
    ...
    function patchNonKeyedChildren(e, t, n, r, o, i, a) {
        for (var s = Math.min(i, a), u = 0; u < s; )
            patch(t[u], n[u], e, r, o),
            u++;
        if (i < a)
            for (u = s; u < a; u++)
                null !== e && e.appendChild(createElement(n[u], o, r));
        else if (i > a)
            for (u = s; u < i; u++)
                unmount(t[u], e)
    }
    function patchKeyedChildren(e, t, n, r, o, i, a) {
        var s, u, l, c, p, f, d, h = i - 1, v = a - 1, y = 0, g = 0, b = e[y], C = t[g], _ = e[h], k = t[v];
        e: {
            for (; b.key === C.key; ) {
                if (patch(b, C, n, r, o),
                y++,
        ...
        if (y > h) {
            if (g <= v)
                for (f = v + 1,
                p = f < a ? t[f].dom : null; g <= v; )
                    d = t[g],
                    g++,
                    attachNewNode(n, createElement(d, o, r), p)
        } else if (g > v)
            for (; y <= h; )
                unmount(e[y++], n);
        else {
            ...
            if (x <= 4 || w * x <= 16) {
                ...
                for (s = y; s <= h; s++)
                    l = e[s],
                    N < x && (u = O.get(l.key)) !== undefined && (c = t[u],
                    E[u - g] = s,
                    T > u ? S = !0 : T = u,
                    patch(l, c, n, r, o),
                    N++,
            ...
            if (w === i && 0 === N)
                ...
                n.textContent = ""; g < x; )
                    d = t[g],
                    g++,
                    attachNewNode(n, createElement(d, o, r), null);
            else {
                for (s = w - N; s > 0; )
                    null !== (l = e[y++]) && (unmount(l, n),
                    s--);
                if (S) {
                    var P = lis(E);
                    for (u = P.length - 1,
                    s = x - 1; s >= 0; s--)
                        ...
                        d = t[T],
                        f = T + 1,
                        attachNewNode(n, createElement(d, o, r), f < a ? t[f].dom : null)) : u < 0 || s !== P[u] ? (T = s + g,
                        d = t[T],
                        f = T + 1,
                        attachNewNode(n, d.dom, f < a ? t[f].dom : null)) : u--
                } else if (N !== x)
                    for (s = x - 1; s >= 0; s--)
                        -1 === E[s] && (T = s + g,
                        d = t[T],
                        f = T + 1,
                        attachNewNode(n, createElement(d, o, r), f < a ? t[f].dom : null))
            }
        }
    }
    ...
    function setStyle(e, t, n) {
        return isNullOrUndef(n) || isNumber(n) && isNaN(n) ? void (e[t] = "") : "float" === t ? (e["cssFloat"] = n,
        void (e["styleFloat"] = n)) : void (e[t] = !isNumber(n) || M.test(t) ? n : n + "px")
    }
    function patchEvent(e, t, n, r) {
        t !== n && (isFunction(t) && detachEvent(r, e, t),
        attachEvent(r, e, n))
    }
    function patchStyle(e, t, n) {
        var r, o, i = n.style;
        if (isString(t))
            return void (i.cssText = t);
        ...
        if (n !== r || "value" === t) {
            ...
            if ("class" !== t || i)
                if ("dangerouslySetInnerHTML" === t) {
                    var a = n && n.__html
                      , s = r && r.__html;
                    a !== s && (isNullOrUndef(s) || (isValidElement(o) && o.children !== y && (unmountChildren(o.children),
                    o.children = []),
                    e.innerHTML = s))
    ...
    function createElement(e, t, n, r) {
        ...
        if (isValidElement(e)) {
            var i = e.vtype;
            12 & i ? (o = e.init(n, r),
            A.afterMount(e)) : 1 & i ? (o = s.createTextNode(e.text),
            e.dom = o) : 2 & i ? o = mountVNode$1(e, t, n, r) : 16 & i ? o = e.dom = s.createTextNode("") : isPortal(i, e) && (e.type.appendChild(createElement(e.children, t, n, r)),
            o = s.createTextNode(""))
        } else if (isString(e) || isNumber(e))
            o = s.createTextNode(e);
        else if (isNullOrUndef(e) || isBoolean(e))
            o = s.createTextNode("");
        else {
            if (!l(e))
    ...
    function mountVNode$1(e, t, n, r) {
        e.isSvg ? t = !0 : "svg" === e.type ? t = !0 : u || (t = !1),
        t && (e.namespace = D,
        e.isSvg = t);
        ...
        if (l(i))
            for (var a = 0, c = i.length; a < c; a++)
                mountChild(i[a], o, n, t, r);
        else
            mountChild(i, o, n, t, r);
        return e.dom = o,
        null !== e.ref && b.attach(e, e.ref, o),
        o
    }
    ...
    function mountComponent(e, t, n) {
        ...
        isFunction(o.componentWillMount) && (errorCatcher(function() {
        ...
        i.parentVNode = e,
        o._rendered = i,
        isFunction(o.componentDidMount) && R.push(o),
        isNullOrUndef(r) || b.attach(e, r, e.dom);
    ...
    function mountStatelessComponent(e, t) {
        ...
        return e._rendered = ensureVirtualNode(n),
    ...
    function reRenderComponent(e, t) {
        var n = t.component = e.component
          ...
          , o = n.context;
        return n._disable = !0,
        isFunction(n.componentWillReceiveProps) && errorCatcher(function() {
        ...
        n.props = r,
        n.context = o,
        isNullOrUndef(t.ref) || b.update(e, t),
        updateComponent(n)
    }
    function reRenderStatelessComponent(e, t, n, r) {
        var o = e._rendered
          , i = t.type(t.props, n);
        return i.parentVNode = t,
        t._rendered = i,
        t.dom = patch(o, i, o && o.dom || r, n)
    }
    function updateComponent(e, t) {
        ...
        !c) {
            ...
            for (r = n.dom = patch(p, f, h || null, d),
            e._rendered = f,
    ...
    function unmountComponent(e) {
        ...
        t._disable = !0,
        unmount(t._rendered),
        isNullOrUndef(e.ref) || b.detach(e, e.ref, e.dom)
    }
    ...
    function render(e, t, n) {
        ...
        return A.roots.push(e),
        o !== undefined ? (A.roots = A.roots.filter(function(e) {
            return e !== o
        }),
    ...
    function h(e, t, n) {
        ...
        l(n) ? (r = [],
        addChildren(r, n, e)) : isString(n) || isNumber(n) ? n = createVText(String(n)) : isValidElement(n) || (n = y),
        t.children = r !== undefined ? r : n,
        createVNode(e, t, t.children, t.key, t.namespace, t.owner, t.ref)
    }
    ...
    function createElement$2(e, t) {
        ...
        var i;
        return isString(e) ? (i = transformPropsForRealTag(e, t),
        i.owner = v.current,
        h(e, i, o)) : isFunction(e) ? (i = transformPropsForComponent(t, e.defaultProps),
        i.children && i.children !== y || (i.children = o || y),
        i.owner = v.current,
        e.prototype && e.prototype.render ? new q(e,i) : new W(e,i)) : e
    }
    function cloneElement(e, t) {
        ...
        if (!isInvalid(e) && isPortal(e.vtype, e) || e && 16 & e.vtype)
            return createVoid();
    ...
    var r, o = function() {
        ...
        return e
    }(), i = "undefined" != typeof window, a = {
        createElement: noop,
        createElementNS: noop,
        createTextNode: noop
    }, s = i ? document : a, u = isFunction(s.createAttributeNS), l = Array.isArray, c = "Promise"in o;
    c && (r = Promise.resolve());
    var p = function(e) {
        ...
        s.addEventListener("selectionchange", function() {
            ...
            if (detectCanUseOnInputNode(e)) {
                ...
                if (n.value !== T[t]) {
                    ...
                    r.initCustomEvent("input", !0, !0, undefined),
                    T[t] = n.value,
                    e.dispatchEvent(r)
                }
            }
    ...
    W.prototype.update = function(e, t, n) {
        ...
        return isFunction(i) && !i(e.props, r, o) ? (t._rendered = e._rendered,
        e.dom) : reRenderStatelessComponent(e, this, n, e.dom)
    }
    ,
    ...
    var H = {
        map: function(e, t, n) {
            return isNullOrUndef(e) ? e : (e = H.toArray(e),
            n && n !== e && (t = t.bind(n)),
            e.map(t))
        },
...
!function(e) {
    ...
    window["webpackJsonp"] = function(n, r, o) {
        for (var a, l, c = 0, s = []; c < n.length; c++)
            l = n[c],
            i[l] && s.push(i[l][0]),
            i[l] = 0;
        for (a in r)
            Object.prototype.hasOwnProperty.call(r, a) && (e[a] = r[a]);
        for (t && t(n, r, o); s.length; )
            s.shift()()
    }
    ;
    var n = {}
    ...
    __webpack_require__.e = function(e) {
        ...
        o.src = __webpack_require__.p + "chunk/" + ({
            0: "corechn1",
            1: "toolbar",
            2: "chn",
            3: "serviceSprite",
            ...
            16: "fallback",
            17: "legacy",
            18: "shortcutUserinfoDropdown",
            19: "shortcutMyjdDropdown",
            20: "news.mock",
            21: "mock/logo.mock",
            22: "mock/scene.mock",
            23: "mock/enjoy-mock_s3-js",
            24: "mock/enjoy-mock_s2-js",
            25: "mock/enjoy-mock_s1-js",
            26: "mock/enjoy-mock_a2-js",
            27: "mock/enjoy-mock_a1-js",
            28: "mock/vogue_3-mock-js",
            29: "mock/vogue_2-mock-js",
            30: "mock/vogue_1-mock-js",
            31: "mock/tech_2-mock-js",
            32: "mock/tech_1-mock-js",
            33: "mock/life_2-mock-js",
            34: "mock/life_1-mock-js",
            35: "mock/house_2-mock-js",
            36: "mock/house_1-mock-js"
        }[e] || e) + ".chunk.js";
        var a = setTimeout(onScriptComplete, 12e4);
        return o.onerror = o.onload = onScriptComplete,
        r.appendChild(o),
        n
    }
    ,
    ...
    ,
    __webpack_require__.p = "//misc.360buyimg.com/mtd/pc/index_2017/2.1.0/",
...
, function(e, t, n) {
    ...
    var m = function(e) {
        ...
        (new Image).src = "" + (i || p.logDomain) + r + "&v=" + (n || p.logV)
    };
    ...
    v(11) ? t.webpSupported = j = !0 : v(12) ? t.webpSupported = j = !1 : pageConfig.disableWebp ? t.webpSupported = j = !1 : function() {
        var e = new Image;
        e.onload = function() {
            t.webpSupported = j = e.width > 0 && e.height > 0,
            b.set("webp", j)
        }
        ,
        e.onerror = function() {
    ...
    var P = function(e, t) {
      ...
      , A = function(e, t) {
        ...
        return o.clip && (n = x(n, o.clip)),
        o.quality && (n = E(n, o.quality)),
        o.replacem && (n = P(n, o.replacem)),
        !0 === j && o.webp && (n = O(n)),
        n
    }
      , N = function() {
      ...
      , R = function(e) {
        if (!Array.isArray(e))
            return e;
        for (var t = 0, n = 0, i = void 0, r = [], o = 0; o < e.length; o++)
            i = e[o].weight ? parseInt(e[o].weight) : 1,
            r[o] = [],
            r[o].push(t),
            t += i,
            r[o].push(t);
      ...
      , F = function(e) {
        ...
        t.name && (window[t.name] = g),
        v(6) && (t.url = "//loadAsyncError.jd.com",
        t.timeout = 1500),
        v(7) && (t.url = "//loadAsyncError.jd.com",
        t.retryTimes = 0,
        t.timeout = 1500,
        t.backup = null),
        v(8) && (t.url = "//loadAsyncError.jd.com",
        t.timeout = 999999999);
        var n = (0,
        s["default"])(t);
        ...
        t.reportHidedId && n["catch"](function(e) {
            t.backup && d["default"].processBackup(t.reportBackupId),
            d["default"].processHidedFloor(t.reportHidedId)
        }),
        v(9) && (n.then(function(n) {
            L.groupCollapsed("%c请求成功: " + e.url, "color: #B1B479"),
            L.log("请求参数:", t),
            L.log("返回结果:", n),
            L.groupEnd()
        }),
        n["catch"](function(n) {
            L.groupCollapsed("%c请求失败: " + e.url, "color: #D05A6E"),
            L.log("请求参数:", t),
            L.log("错误对象:", n),
            L.groupEnd()
        })),
        ...
        return J.userinfo || (J.userinfo = new Promise(function(e, t) {
            K().then(function(t) {
                t.isLogin ? F({
                    ...
                    t.userLevel = Number(t.userLevel) || 1,
                    t.plusStatus = Number(t.plusStatus) || 0,
                    v(131) && (t.plusStatus = 0),
                    v(132) && (t.plusStatus = 1),
                    v(133) && (t.plusStatus = 2),
                    v(134) && (t.plusStatus = 3),
                    v(135) && (t.plusStatus = 4),
                    v(136) && (t.plusStatus = 5),
                    e(t)
                })["catch"](function() {
                    e({})
                }) : e({})
      ...
      , ee = function(e, t, n) {
        ...
        i || (i = {});
        var s = function() {
            c = !1 === i.leading ? 0 : (new Date).getTime(),
            l = null,
            a = e.apply(r, o),
            l || (r = o = null)
        };
        return function() {
            ...
            return r = this,
            o = arguments,
            u <= 0 || u > t ? (clearTimeout(l),
            l = null,
            c = n,
            a = e.apply(r, o),
            l || (r = o = null)) : l || !1 === i.trailing || (l = setTimeout(s, u)),
            a
        }
    }
      , te = function(e) {
      ...
      , ne = function(e) {
        ...
        if (n) {
            var o = void 0;
            for (e.length % t != 0 && (o = e.slice(-1 * t)); i.length >= t; )
                r.push(i.splice(0, t));
            o && r.push(o)
        } else
            for (; i.length > 0; )
      ...
      , oe = function() {
        return n.e(17).then(n.bind(null, 110)).then(function() {
            seajs.config({
                alias: {
    ...
    window.addEventListener("resize", function() {
        var e = null
          ...
          , i = function onResize() {
            ...
            v(2) ? t.isWide = ue = !1 : v(3) ? t.isWide = ue = !0 : t.isWide = ue = i >= 1190,
            pageConfig.wideVersion !== ue && (pageConfig.wideVersion = ue,
            ue ? (n.removeClass("o2_mini"),
            n.addClass("o2_wide"),
            n.addClass("root61")) : (n.removeClass("o2_wide"),
            n.removeClass("root61"),
            n.addClass("o2_mini")),
            ...
            ce === i && se === r || (e && window.clearTimeout(e),
            e = window.setTimeout(onResize, 100)),
            ce = i,
            se = r
        };
        return i(),
    ...
    var de = function(e, t) {
        ...
        if (t) {
            ...
            n = e.top,
            i = e.bottom;
        return window.pageYOffset < i && window.pageYOffset + se > n
    }
      , fe = /^ *contury_/.test(y("PCSYCity"))
      , pe = function(e, t) {
        var n = t.error;
      ...
      , me = Date.now()
      , he = me > 15292512e5 && me < 15293376e5 || v(618)
      , ge = function() {
        var e = y("ipLoc-djd");
        if (/\d+-\d+-\d+-\d+/.test(e))
      ...
      , be = function(e) {
        if (e >= _e.ZERO && e <= _e.NINE)
            return !0;
        if (e >= _e.NUM_ZERO && e <= _e.NUM_MULTIPLY)
            return !0;
        if (e >= _e.A && e <= _e.Z)
            return !0;
...
, function(e, t, n) {
    ...
    var i = n(0)
      ...
      , c = {
        ...
        MORE_CHOOSEN: "//dy.jd.com/jsf_selection_online",
    ...
    (0,
    a.isdebug)(29) || ((0,
    a.isdebug)(30) || pageConfig.goodShopSectionStart && o.USER.unifiedHash < pageConfig.goodShopSectionStart) && (c.CHN = "//f.3.cn/index-floor-scene",
    c.CHN_BAK = "//www.3.cn/index/bak/"),
    (0,
    a.isdebug)(17) && (c.USER_SPOINT = "//floor.jd.com/user/score/get?auth=qazwsc"),
    (0,
    a.isdebug)(18) && (l.JOY = "//portal.cms.jd.com/preview/preview/preview/6153"),
    (0,
    a.isdebug)(20) && (c.PRICE = "//p.3.local/prices/mgets?source=pc_home");
    var s = {
        REQ_TIMES: 3e3,
        REQ_TIMEOUT: 3e3,
    ...
    (0,
    a.isdebug)(31) || ((0,
    a.isdebug)(32) || pageConfig.newsSectionStart && o.USER.unifiedHash < pageConfig.newsSectionStart) && (u = !1),
    s.showNews = u;
    var d = "开通PLUS 平均省1012元/年"
      , f = [d, d, d, "现在续费PLUS享特惠价", "续费PLUS 平均省1012元/年", "只差一步 激活PLUS享特权"]
      , p = [];
    t.APIS = c,
    t.URLS = l,
    t.CONSTS = s,
...
, function(e, t, n) {
    ...
    : function(e) {
      ...
      , c = {
        ...
        log: function() {
            function log(e) {
                ...
                if (t = e || this.arr.shift()) {
                    if ((0,
                    o.isdebug)(13)) {
                        o.dconsole.groupCollapsed("%c" + t.comment + "曝光: " + t.logData.poi, "color: rgb(255, 208, 64)"),
                        o.dconsole.log(t.logData),
                        o.dconsole.groupEnd()
                    }
        ...
        push: function() {
            function push(e, t) {
                var n = this;
                t ? this.log(e) : this.arr.push(e),
                (0,
                o.afterLoad)().then(function() {
                    n.start()
                })
            }
            return push
      ...
      , u = function(e) {
        ...
        (0,
        o.isdebug)(5) || window.log && window.log("pc_homepage", "basic", n, r, b, w, y, m, g)
    }
      ...
      , g = {
            ...
            function _start() {
                ...
                this.timer = setInterval(function() {
                    ...
                    if (!t)
                        return e._stop();
                    var n = (0,
                    o.getElementPos)(t.el);
                    !t.el || (0,
                    o.isInViewport)(n) ? e._send(t.clog) : e.monitorArr.push(i({}, t, {
                        posObj: n
                    }))
                }, 200))
            }
        ...
        _send: function() {
            function _send(e) {
                var t = new Image;
                !/[a-zA-Z]/.test(e) && pageConfig.clog && pageConfig.clog.logDomain && pageConfig.clog.logV ? t.src = pageConfig.clog.logDomain + e + "&v=" + pageConfig.clog.logV : t.src = e,
                this.sent[e] = 1
            }
            return _send
        }(),
            ...
            function _onScroll() {
                if (this.monitorArr.length)
                    for (var e = this.monitorArr.length; e--; ) {
                        ...
                        (0,
                        o.isInViewport)(t.posObj) && (this._send(t.clog),
                        this.monitorArr.splice(e, 1))
                    }
                else
                    this._unBind()
            }
    ...
    var v = function(e) {
      ...
      , _ = function(e) {
        if (e) {
            ...
            if ("string" == typeof opts)
                ...
                if ("object" !== (void 0 === e ? "undefined" : r(e)) || !e.clog)
                    return;
                t = e
            }
            v(t.clog) || (0,
      ...
      , y = function(e) {
        if (e && !(e.length < 10)) {
            var t = new Image
              , n = e + "&m=UA-J2011-1&ref=" + encodeURIComponent(document.referrer) + "&random=" + Math.random();
            if ((0,
            o.isdebug)(13)) {
                o.dconsole.log("%cImageLog: " + n, "color: #2EA9DF")
            }
    ...
    function loadMap(e) {
        ...
        try {
            Object.keys(e).forEach(function(i) {
                var r = load(e[i]);
                r.loading ? t.loading = !0 : (t.loaded[i] = r.loaded,
                t.error = r.error),
                n.push(r.promise),
...
, function(e, t, n) {
    function addStylesToDom(e, t) {
        for (var n = 0; n < e.length; n++) {
            ...
            if (o) {
                ...
                for (var l = [], a = 0; a < r.parts.length; a++)
                    l.push(addStyle(r.parts[a], t));
                i[r.id] = {
                    id: r.id,
                    refs: 1,
                    parts: l
    ...
    function addStyle(e, t) {
        ...
        if (t.singleton) {
            var c = l++;
            n = a || (a = createStyleElement(t)),
            i = applyToSingletonTag.bind(null, n, c, !1),
            r = applyToSingletonTag.bind(null, n, c, !0)
        } else
    ...
    function updateLink(e, t, n) {
        ...
        (t.convertToAbsoluteUrls || o) && (i = s(i)),
    ...
    var n = {
        ...
        getBaseData: function() {
            function getBaseData() {
                ...
                if (e && t) {
                    ...
                    r && n.push("s73=" + (r.getTime() - t.getTime())),
                    o && n.push("s74=" + (o.getTime() - t.getTime())),
                    a && n.push("s75=" + (a.getTime() - t.getTime())),
        ...
        processJsError: function() {
            function processJsError() {
                ...
                i > 0 && n >= 0 && n <= i && $(e).bind("error.o2report", function(t, n, i, r, o) {
                    var a = "";
                    if (r = r || e.event && e.event.errorCharacter || 0,
                    o && o.stack)
                        t = o.stack.toString();
                    else if (arguments.callee) {
                        for (var l = [t], c = arguments.callee.caller, s = 3; c && --s > 0 && (l.push(c.toString()),
                        c !== c.caller); )
                            c = c.caller;
                        t = l.join(",")
                    }
                    if (a = JSON.stringify(t) + (n ? ";URL:" + n : "") + (i ? ";Line:" + i : "") + (r ? ";Column:" + r : ""),
                    e.lastErrMsg) {
                    ...
                    setTimeout(function() {
                        ...
                        (new Image).src = "//wq.jd.com/webmonitor/collect/badjs.json?Content=" + a + "&t=" + Math.random()
                    }, 1e3)
                })
            }
        ...
        init: function() {
            function init(e, t, n, i) {
                var r = this;
                if (!e)
                    return void r.debug("pageId must be provided!");
                r.pid = e,
                r.pFloorId = n,
                r.pBackupId = t,
                r.pTemplId = i,
            ...
            value: function() {
                function switchTo(e) {
                    ...
                    if ((t = parseInt(t, 10)) !== this.index)
                        return this.index = t,
                        "function" == typeof n.onBeforeSwitch && n.onBeforeSwitch.call(this, t, this),
                        this.$headItems.removeClass(n.activeClass).eq(t).addClass(n.activeClass),
                        this.$contentItems.hide().eq(t).show(),
                        "function" == typeof n.onAfterSwitch && n.onAfterSwitch.call(this, t, this),
                        this.$headItems[t].hasShown || "function" != typeof n.onFirstShow || (n.onFirstShow.call(this, t, this),
    ...
    var r = n(0)
      ...
      , l = function(e) {
        function Lazyimg() {
            ...
            ,
            e.load = e.load.bind(e),
            e
        }
        return _inherits(Lazyimg, e),
        i(Lazyimg, [{
            key: "done",
            value: function() {
                function done() {
                    ...
                    this.imgDom && (this.imgDom.src = e),
                    this.ctnDom && (this.ctnDom.className = (0,
                    a.mergeClassName)("lazyimg", "lazyimg_loaded", t))
                }
                return done
            }()
        }, {
            ...
            value: function() {
                function error() {
                    ...
                    this.imgDom && (this.imgDom.src = e),
                    this.ctnDom && (this.ctnDom.className = (0,
                    a.mergeClassName)("lazyimg", "lazyimg_loaded", "lazyimg_error", t))
                }
                return error
            }()
        }, {
            ...
            value: function() {
                function componentWillReceiveProps(e) {
                    e.src !== this.props.src && this.load(e.src)
                }
...
, function(e, t, n) {
    ...
    function checkVisible(e) {
        ...
        if (t) {
            var n = void 0;
            if (e.props.overflow && (n = getScrollParent(t)),
            n && n !== window ? checkOverflowVisible(e, n) : checkNormalVisible(e)) {
                if (!e.visible) {
                ...
                e.props.once && e.visible || (e.visible = !1,
    ...
    function checkNormalVisible(e) {
        var t = a["default"].findDOMNode(e);
        if (!(t.offsetWidth || t.offsetHeight || t.getClientRects && t.getClientRects().length))
            return !1;
        var n = void 0
          , i = void 0;
        try {
        ...
        r(LazyLoad, [{
            ...
            value: function() {
                function componentDidMount() {
                    ...
                    void 0 !== n && m !== l ? (h = !0,
                    m = l,
                    v = n >>> 0) : void 0 !== i && m !== c && (h = !0,
                    m = c,
                    v = i >>> 0),
                    h && (e.removeEventListener("scroll", f),
                    e.removeEventListener("resize", p),
                    f = null,
                    p = null),
                    f || (f = g[m](lazyLoadHandler, v));
                    var _ = void 0;
                    if (r && (_ = getScrollParent(a["default"].findDOMNode(this))),
                    _ && _ !== window) {
                        if (_.getAttribute) {
                            var b = 1 + _.getAttribute(s) | 0;
                            1 === b && _.addEventListener("scroll", f),
                            _.setAttribute(s, b)
                        }
                    } else if ((0 === u.length || h) && (o && e.addEventListener("scroll", f),
                    d)) {
                        var y = getWinSize()
                          , w = y.width
                          , k = y.height
                ...
                function componentWillUnmount() {
                    ...
                    if (this.props.overflow) {
                        ...
                        if (t && t.getAttribute) {
                            ...
                            0 === n ? (t.removeEventListener("scroll", f),
                            t.removeAttribute(s)) : t.setAttribute(s, n)
                        }
                    }
                    var i = u.indexOf(this);
                    i >= 0 && u.splice(i, 1),
                    0 === u.length && (e.removeEventListener("scroll", f),
...
, function(e, t, n) {
    ...
    function getWidth(e) {
        ...
        return t > 0 ? t : (t = d(e, "width"),
        (t < 0 || null == t) && (t = e.style["width"] || 0),
        t = parseFloat(t) || 0)
    }
    function getHeight(e) {
        ...
        return t > 0 ? t : (t = d(e, "height"),
        (t < 0 || null == t) && (t = e.style["height"] || 0),
        t = parseFloat(t) || 0)
    }
    function addClassName(e, t) {
        var n = e;
        return null === t || t === undefined || !1 === t ? n : (n = n || "",
        n = n.split(" "),
        n.push(t),
        n = n.join(" "))
    }
    ...
    var i = Object.assign || function(e) {
      ...
      , c = function(e) {
        function Slider() {
            ...
            return e.sliderItems = [],
            e.sliderWrapperRef = function(t) {
                e.sliderWrapper = t
            }
            ,
        ...
        return _inherits(Slider, e),
        r(Slider, [{
            key: "componentWillReceiveProps",
            value: function() {
                function componentWillReceiveProps(e) {
                    this.sliderItems.splice(this.props.children.length),
                    this.pause(),
                    this.initSlider(e)
                }
                return componentWillReceiveProps
            ...
            value: function() {
                function initSlider(e) {
                    ...
                    if (!(u <= 0)) {
                        ...
                        l && (m += (u - 1) * c);
                        var h = {};
                        if (l ? h.height = (u + 2 * i) * p : h.width = (u + 2 * i) * d,
                        !s) {
                        ...
                        this.setState({
                            ...
                            o && t.sliderItems.forEach(function(e, n) {
                                n === t.state.currentSlide ? (e.style.opacity = 1,
                                e.style.filter = "alpha(opacity=100)",
                                e.style.zIndex = 1) : (e.style.opacity = 0,
                                e.style.filter = "alpha(opacity=0)",
                                e.style.zIndex = 0)
                            }),
                            n.autoPlay && (t.pauseState = !1),
                            t.autoPlay(n)
                        })
                    }
                }
            ...
            value: function() {
                function autoPlay(e) {
                    ...
                    t.autoPlay && !this.pauseState && (this.autoPlayTimer = setTimeout(this.play.bind(this), t.autoPlayInterval))
                }
                return autoPlay
            }()
        }, {
                ...
                function slideTo(e) {
                    ...
                    if (!this.animating) {
                        ...
                        a) {
                            if (!1 === l && (e < 0 || e >= _))
                                return;
                            return r = e < 0 ? e + _ : e >= _ ? e - _ : e,
                            this.props.lazyLoad && b.indexOf(r) < 0 && this.setState({
                                lazyLoadedList: b.concat(r)
                            }),
                            s && s.call(this, n, r),
                            this.animating = !0,
                            g || this.sliderItems.forEach(function(e, t) {
                                t === r ? (e.style.zIndex = 1,
                                f(e, u, h)) : t === n && (e.style.zIndex = 0,
                                p(e, u))
                            }),
                            this.setState({
                                currentSlide: r
                        ...
                        r = e,
                        n = r < 0 ? !1 === l ? 0 : _ % d != 0 ? _ - _ % d : _ + r : r >= _ ? !1 === l ? _ - m : _ % d != 0 ? 0 : r - _ : r;
                        ...
                        this.props.lazyLoad) {
                            for (var S = !0, C = [], x = r; x < r + m; x++)
                                (S = S && this.state.lazyLoadedList.indexOf(x) >= 0) || (x < 0 ? C.push(x + _) : C.push(x));
            ...
            value: function() {
                function slideCore(e, t, n, i) {
                    var r = this.props
                      ...
                      , s = r.noChangeSelf;
                    this.animating = !0,
                    s || m(this.sliderWrapper, l, c, o, t, n),
                    this.setState({
                        currentSlide: e
                    }, function() {
                        var t = this;
            ...
            value: function() {
                function changeSlide(e, t) {
                    var n = void 0
                      ...
                      , u = c % o != 0
                      , d = u ? 0 : (c - s) % o;
                    "previous" === e ? (n = 0 === d ? o : a - d,
                    i = s - n) : "next" === e ? (n = 0 === d ? o : d,
                    i = s + n) : "indicate" === e && (this.animating = !1,
            ...
            value: function() {
                function onSliderOut(e) {
                    this.props.pauseOnHover && (this.pauseState = !1,
                    this.autoPlay())
                }
                return onSliderOut
            }()
            ...
            value: function() {
                function canGoPrev() {
                    if (!this.props.infinite) {
                        var e = this.state.slideCount
                          , t = this.props.slidesToShow;
                        if (0 === this.state.currentSlide || e <= t)
                            return !1
                    }
                    return !0
                }
            ...
            value: function() {
                function renderSlides() {
                    ...
                    return i.forEach(function(t, n) {
                        ...
                        var y = b.slice(0);
                        h <= n && n < h + p ? y.push("slider_active") : n >= h + p && n < h + p + m || h >= v - 1 && 0 === n ? y.push("slider_next") : (n < h && n >= h - p - m || 0 === h && n === v - 1) && y.push("slider_prev"),
                        _ = extend(i.props.style || {}, _),
                        r.push(a["default"].cloneElement(i, {
                        ...
                        d && !u && (n >= s - p && (c = -(s - n),
                        o.push(a["default"].cloneElement(i, {
                        ...
                        n < p && (c = s + n,
                        l.push(a["default"].cloneElement(i, {
            ...
            value: function() {
                function getSlideStyle(e) {
                    var t = this.props
                      , n = this.state
                      , i = {};
                    return i.width = n.slideWidth,
                    t.vertical || (i["float"] = "left"),
                    t.fade && (i.position = "relative",
                    i.left = -e * n.slideWidth,
                    l && (i.transition = "opacity " + t.speed + "ms " + t.easeType,
                    i.WebkitTransition = "opacity " + t.speed + "ms " + t.easeType)),
                    i
                }
            ...
            value: function() {
                function getSliderWrapperStyle(e, t) {
                    ...
                    if (s ? u.height = (r + 2 * c) * a : u.width = (r + 2 * c) * o,
                    l) {
            ...
            value: function() {
                function getSliderLeftOffset(e, t) {
                    ...
                    if (s)
                        i >= u && (f = r * u * -1,
                        p = o * u * -1),
                        i % d != 0 && n + d > i && i > u && (n > i ? (f = (u - (n - i)) * r * -1,
                        p = (u - (n - i)) * o * -1) : (f = i % d * r * -1,
                        p = i % d * o * -1));
            ...
            value: function() {
                function render() {
                    ...
                    e.arrows && (t = a["default"].createElement(h, u),
                    n = a["default"].createElement(h, d));
                    var f = {
    ...
    document.defaultView && document.defaultView.getComputedStyle && (s = function(e, t) {
        ...
        return (i = e.ownerDocument.defaultView) ? ((r = i.getComputedStyle(e, null)) && ("" !== (n = r.getPropertyValue(o)) || jQuery.contains(e.ownerDocument.documentElement, e) || (n = jQuery.style(e, o))),
        n) : undefined
    }
    ),
    document.documentElement.currentStyle && (u = function(e, t) {
        var n = void 0
          ...
          , o = e.style;
        return !/^-?\d+(?:px)?$/i.test(i) && /^-?\d/.test(i) && (n = o.left,
        r && (e.runtimeStyle.left = e.currentStyle.left),
        o.left = "fontSize" === t ? "1em" : i || 0,
        i = o.pixelLeft + "px",
        o.left = n,
    ...
    var d = s || u
      , f = function(e, t, n, i) {
        if (e) {
            if (l)
                ...
                void (e.style.transition = "opacity " + t + "ms " + n);
            ...
            t) {
                var r = 0
                  ...
                  , a = function done() {
                    r += 16 / t,
                    r >= 1 ? (o && clearTimeout(o),
                    r = 1,
                    e.style.opacity = r,
                    e.style.filter = "alpha(opacity=" + 100 * r + ")",
                    i && i()) : (e.style.opacity = r,
                    e.style.filter = "alpha(opacity=" + 100 * r + ")",
                    o && clearTimeout(o),
                    o = setTimeout(done, 16))
                };
                o = setTimeout(a, 16)
            } else
                e.style.opacity = 1,
      ...
      , m = function(e, t, n, i, r, o) {
        if (l)
            return e.style.msTransition = "msTransform " + t + "ms " + n,
            e.style.webkitTransition = "webkitTransform " + t + "ms " + n,
            e.style.transition = "transform " + t + "ms " + n,
            void (i ? (e.style.webkitTransform = "translate3d(0px, " + o + "px, 0px)",
            e.style.msTransform = "translateY(" + o + "px)",
            e.style.transform = "translate3d(0px, " + o + "px, 0px)") : (e.style.webkitTransform = "translate3d(" + o + "px, 0px, 0px)",
            e.style.msTransform = "translateX(" + o + "px)",
            e.style.transform = "translate3d(" + o + "px, 0px, 0px)"));
        if (i ? e.top = r + "px" : e.left = r + "px",
        t && o !== r) {
            var a = null
              , c = o - r
              , s = r
              , u = function done() {
                c > 0 ? (s += 30 * Math.abs(c / t),
                s >= o ? (a && clearTimeout(a),
                s = o,
                i ? e.style.marginTop = s + "px" : e.style.marginLeft = s + "px") : (i ? e.style.marginTop = s + "px" : e.style.marginLeft = s + "px",
                a && clearTimeout(a),
                a = setTimeout(done, 30))) : (s -= 30 * Math.abs(c / t),
                s <= o ? (a && clearTimeout(a),
                s = o,
                i ? e.style.marginTop = s + "px" : e.style.marginLeft = s + "px") : (i ? e.style.marginTop = s + "px" : e.style.marginLeft = s + "px",
                a && clearTimeout(a),
                a = setTimeout(done, 30)))
            };
            a = setTimeout(u, 16)
        } else
            i ? e.top = o + "px" : e.left = o + "px"
    }
      , h = function(e) {
        function Arrow() {
            return _classCallCheck(this, Arrow),
            _possibleConstructorReturn(this, (Arrow.__proto__ || Object.getPrototypeOf(Arrow)).apply(this, arguments))
        }
        return _inherits(Arrow, e),
        r(Arrow, [{
            key: "onClick",
            value: function() {
                function onClick(e) {
            ...
            value: function() {
                function render() {
                    ...
                    t || (n = addClassName(n, "slider_control_disabled"),
                    i = null);
                    var r = {
                        className: n,
                        onClick: i
      ...
      , g = function(e) {
        function Indicators() {
            return _classCallCheck(this, Indicators),
            _possibleConstructorReturn(this, (Indicators.__proto__ || Object.getPrototypeOf(Indicators)).apply(this, arguments))
        }
        return _inherits(Indicators, e),
        r(Indicators, [{
            key: "onItemHandler",
            value: function() {
                ...
                function renderIndicatorItems() {
                    ...
                    return function() {
                        for (var t = [], l = 0; l < n; l++) {
                            ...
                            l === n - 1 && (c = addClassName(c, "slider_indicators_btn_last")),
                            l === i && (c = addClassName(c, "slider_indicators_btn_active"));
                            var d = o(l);
...
, function(e, t, n) {
    ...
    var r = n(4)
      ...
      , c = function() {
        function Cate(e) {
            ...
            this.postSendImpl = function(e) {
                try {
                    t._sideImplTimer && clearTimeout(t._sideImplTimer),
                    t._sideImplTimer = setTimeout(function() {
        ...
        return i(Cate, [{
            ...
            value: function() {
                function init() {
                    ...
                    e.isSubDataLoaded = !1,
                    e.isPopMenuBinded = !1,
                    e.dataUrl = r.APIS.CATEA,
                    e.dataBackupUrl = r.APIS.CATEA_STOBACKUP,
                    ...
                    "boolean" == typeof pageConfig.isCateUseA ? pageConfig.isCateUseA || (e.dataUrl = r.APIS.CATEB,
                    e.dataBackupUrl = r.APIS.CATEB_BACKUP,
                    e.scriptCharset = "utf-8") : a || (e.dataUrl = r.APIS.CATEB,
                    e.dataBackupUrl = r.APIS.CATEB_BACKUP,
                    e.scriptCharset = "utf-8"),
                    pageConfig.leftCateABtestUseA = a,
                    e.imgIndex = 0,
            ...
            value: function() {
                function initSubCate() {
                    ...
                    e.conf.isSubDataLoaded || e.getSubCateData(this.conf.type, function() {
                        var i = $("#J_popCtn");
                        n.e(15).then(n.bind(null, 113)).then(function(n) {
                            new (0,
                            n["default"])({
                                $container: t,
                    ...
                    for (a = 0; a < l; a++) {
                        ...
                        s = 0; s < u; s++)
                            ...
                            f = 0; f < p; f++) {
                                ...
                                b = '<dt class="cate_detail_tit" clstag="' + o(i(a), "c", i(f)) + '">' + v + "</dt>",
                                _ = "",
                                0 !== m)
                                    for (g = m.length,
                                    h = 0; h < g; h++)
                                ...
                                _ = '<dd class="cate_detail_con" clstag="' + o(i(a), "d", i(f)) + '">' + _ + "</dd>",
                                y += '<dl class="cate_detail_item cate_detail_item' + (f + 1) + '">' + b + _ + "</dl>"
                            }
                        for (y = '<div class="cate_detail">' + y + "</div>",
                        S += y + "</div>",
                        k = "",
                        u = c.b.length,
                        s = 0; s < u; s++)
                        ...
                        for (k = '<div class="cate_brand">' + k + "</div>",
                        C += k,
                        x = "",
                        u = c.p.length,
                        s = 0; s < u; s++)
                        ...
                        x = '<div class="cate_promotion">' + x + "</div>",
                        C += x + "</div>",
                        r += '<div class="cate_part clearfix" id="cate_item' + (a + 1) + '" data-id="' + c.id + '">' + S + C + "</div>"
                    }
            ...
            value: function() {
                function getLinkHtml(e) {
                    ...
                    void 0 !== o && /^\d.*\d$/.test(u[0]) && (2 === o ? p = "channel.jd.com/" + u[0] + ".html" : 3 === o && (2 === u[0].split("-").length ? p = "channel.jd.com/" + u[0] + ".html" : 3 === u[0].split("-").length && (p = "list.jd.com/list.html?cat=" + u[0].replace(/-/g, ",")))),
                    p = "//" + p,
                    ...
                    var m = "";
                    return m = u[0] ? '<a href="' + p + '" ' + f + s + ' target="_blank">' : "<span " + f.replace(/lk/, "txt") + ">",
                    u[2] ? (this.conf.imgIndex > 4 && (this.conf.imgIndex = 0),
                    i = i ? ' width="' + i + '"' : "",
                    r = r ? ' height="' + r + '"' : "",
                    m += '<img data-lazy-img="//img1' + this.conf.imgIndex + ".360buyimg.com/" + u[2] + '"  ' + i + r + ' src="//misc.360buyimg.com/mtd/pc/common/img/blank.png" data-webp="no"/>',
                    this.conf.imgIndex += 1) : m += (a || "") + u[1] + (l || ""),
                    u[0] ? m += "</a>" : m += "</span>",
                    3 === o && 0 === c && 1 === parseInt(u[3], 10) && u[0] && (d.push(n + "_hot"),
                    f = 'class="' + d.join(" ") + '"',
                    m = '<a href="' + p + '" ' + f + ' target="_blank"><i class="cate_con_hot_l"></i>' + (a || "") + u[1] + (l || "") + '<i class="cate_con_hot_r"></i></a>'),
                    m
                }
                return getLinkHtml
            }()
    ...
    c.NO_HTTPS_DOMAIN_REG = /^\/\/(car\.jd\.com|group\.jd\.com|huishou\.jd\.com|dujia\.jd\.com)/,
    t["default"] = c
}
, function(e, t, n) {
    function _interopRequireDefault(e) {
    ...
    var o = n(0)
      ...
      , h = function(e) {
        function User() {
            ...
            return e.clstagPrefix = l.CONSTS.CLSTAGPREFIX,
            e.poi = "head|login",
            e.getExtraInfo = function(t) {
                var n = i(t, 2)
                  , r = n[0]
                  , o = n[1];
                return new Promise(function(t, n) {
                    ...
                    "string" == typeof d && d.length && (u.nickName = d),
                    u.isLogin = r.isLogin,
                    t(u)
                }
                )
        ...
        r(User, [{
                    ...
                    this.getBaseInfo().then(this.getExtraInfo).then(function(t) {
                        ...
                        s.afterLoad)().then(function() {
                            var n = {
                              ...
                              , i = [];
                            i.push((0,
                            s.getNewuserinfo)().then(function(e) {
                                n.isNew = e.isNew
                            })),
                            t.isCompany || i.push((0,
                            s.getSpoint)().then(function(e) {
                                n.spoint = e.spoint
                            })),
                            t.realImgUrl && (n.imgUrl = t.realImgUrl),
            ...
            value: function() {
                function render() {
                    ...
                    return a["default"].createElement("div", {
                        className: (0,
                        s.mergeClassName)("user_inner", "user_level" + i, "user_plus" + n)
                    }, a["default"].createElement("div", {
    ...
    var l = n(1)
      ...
      , f = function(e) {
        function News() {
            ...
            return e.clstagPrefix = c.CONSTS.CLSTAGPREFIX,
            e.poi = "head|news",
            e.state = {
                list: []
            },
        ...
        r(News, [{
            ...
            value: function() {
                function processData(e) {
                    var t = this
                      , n = e.data;
                    if (0 !== e.code)
                        return void l.dconsole.error("数据错误0", e);
                    if (!n || n.length < 4)
                        return void l.dconsole.error("数据错误1", e);
                    n[0].tag = "公告",
                    n[0].linkType = n[0].tag + "01",
                    n[0].linkUrl = c.URLS.NEWS + "notice?id=" + n[0].id,
                    n[1].tag = "活动",
                    n[1].linkType = n[1].tag + "01",
                    n[1].linkUrl = n[1].url;
                    var i = (0,
                    l.getHash)(n[2].title + n[2].id || "", 6);
                    n[2].tag = d[i],
                    n[2].linkType = n[2].tag + "03",
                    n[2].linkUrl = c.URLS.NEWS + "article?id=" + n[2].id,
                    n[3].tag = d[(i + 1) % d.length],
                    n[3].linkType = n[3].tag + "04",
                    n[3].linkUrl = c.URLS.NEWS + "article?id=" + n[3].id,
                    this.moreLink = this.getMoreLink(n),
                    this.setState({
                        list: n
                    }, function() {
                        (0,
            ...
            value: function() {
                function requestData() {
                    ...
                    if ((0,
                    l.isdebug)(21))
                        e = n.e(20).then(n.bind(null, 114)).then(function(e) {
                            return e["default"]
                        });
                    else {
                        var t = {
                ...
                function render() {
                    ...
                    return 0 === t.length ? "" : a["default"].createElement("div", {
                        ...
                        return a["default"].createElement("li", {
                            className: (0,
                            l.mergeClassName)("news_item", "news_item__" + n)
                        }, a["default"].createElement("a", {
                            href: t.linkUrl,
                            target: "_blank",
                            className: "news_link",
...
, function(e, t, n) {
    ...
    }), $(".service_ico_baitiao")[0]),
    o["default"].render(o["default"].createElement(f["default"], {
        className: "service_ico_svg"
    }), $(".service_ico_dianying")[0]),
    o["default"].render(o["default"].createElement(m["default"], {
        className: "service_ico_svg"
    }), $(".service_ico_huafei")[0]),
    o["default"].render(o["default"].createElement(g["default"], {
        className: "service_ico_svg"
    }), $(".service_ico_huoche")[0]),
    o["default"].render(o["default"].createElement(_["default"], {
        className: "service_ico_svg"
    }), $(".service_ico_jiayou")[0]),
    o["default"].render(o["default"].createElement(y["default"], {
        className: "service_ico_svg"
    }), $(".service_ico_jipiao")[0]),
    o["default"].render(o["default"].createElement(k["default"], {
        className: "service_ico_svg"
    }), $(".service_ico_jiudian")[0]),
    o["default"].render(o["default"].createElement(C["default"], {
        className: "service_ico_svg"
    }), $(".service_ico_licai")[0]),
    o["default"].render(o["default"].createElement(E["default"], {
        className: "service_ico_svg"
    }), $(".service_ico_lipin")[0]),
    o["default"].render(o["default"].createElement(I["default"], {
        className: "service_ico_svg"
    }), $(".service_ico_qyg")[0]),
    o["default"].render(o["default"].createElement(P["default"], {
        className: "service_ico_svg"
    }), $(".service_ico_youxi")[0]),
    o["default"].render(o["default"].createElement(A["default"], {
        className: "service_ico_svg"
    ...
    var R = !0
      , M = function() {
        function Service(e) {
            ...
            this.postSendImpl = function(e) {
                try {
                    t._menuTabTimer && clearTimeout(t._menuTabTimer),
                    t._menuTabTimer = setTimeout(function() {
                ...
                onAfterSwitch: function() {
                    function onAfterSwitch(e, t) {
                        var i = t.$contentItems.eq(e)
                          , r = n.opts.data[e];
                        i[0].loaded || (r.isIframe ? (i.removeClass("mod_loading"),
                        i.html($('<iframe width="160" height="180" frameborder="0" scrolling="no" src="' + r.url + '">'))) : (0,
                        c.loadLegacy)().then(function() {
        ...
        return i(Service, [{
            ...
            value: function() {
                function loadSprite() {
                    L || n.e(3).then(n.bind(null, 115)).then(function(e) {
            ...
            value: function() {
                function init() {
                    ...
                    this.opts.head.delegate(".mod_tab_head_item", "mouseenter", function(o) {
                        ...
                        R && (R = !1,
                        i.opts.startAt = a.index(),
                        i.tab = new l["default"](i.opts)),
                        e.postSendImpl(a),
                        clearTimeout(r),
                        r = setTimeout(function() {
                            t || n || (i.opts.col.addClass(i.opts.colExpandClass),
                            i.opts.container.addClass(i.opts.expandClass),
                            t = !0)
                        }, 200)
                    }),
                    ...
                    this.opts.close.bind("click", function(e) {
                        ...
                        t = !1,
                        n = !0,
                        i.opts.col.removeClass(i.opts.colExpandClass),
                        i.opts.container.removeClass(i.opts.expandClass)
                    })
                }
                return init
            }()
...
, function(e, t, n) {
    ...
    var u = n(4)
      ...
      , X = n(106);
    n(107),
    h["default"].init(939, 951, 941, 942),
    (0,
    g.initClicklogger)(),
    (0,
    g.logImpr)({
    ...
    (0,
    d.isdebug)(15) || ((0,
    d.isdebug)(16) || pageConfig.gatewaySection && p["default"].unifiedHash > pageConfig.gatewaySection) && (Z = !1);
    var ee = !0;
    (0,
    d.isdebug)(10) || (window.pageConfig.timestamp < 15401376e5 || window.pageConfig.timestamp > 15422976e5) && (ee = !1),
    (0,
    d.isdebug)(20) && (pageConfig.enableEnjoy = !1);
    var te = pageConfig.enjoyType
      , ne = null
      , ie = null;
    if (te) {
        switch (te) {
        ...
        o(Index, [{
            ...
            value: function() {
                function componentDidMount() {
                    ...
                    d.bindHotkey)(),
                    (0,
                    d.afterLoad)().then(function() {
                        e.runDelayedWorks(),
                        pageConfig.enableEnjoy || Promise.all([(0,
                        d.getNewuserinfo)(), (0,
                        d.getCompanyinfo)()]).then(function(t) {
                            var n = r(t, 2)
                              , i = n[0]
                              , o = n[1]
                              , a = i.isNew
            ...
            value: function() {
                function loadToolbar() {
                    return n.e(1).then(n.bind(null, 109)).then(function(e) {
                        e["default"]()
                    })
                }
                return loadToolbar
            ...
            value: function() {
                function runDelayedWorks() {
                    var e = this;
                    if (null === (0,
                    d.readCookie)("PCSYCityID") && ((new Image).src = "//floor.jd.com/recommend/lbs/get?t=" + (new Date).getTime()),
                    (0,
                    d.cookieCheck)(),
                    (0,
                    d.loadLegacy)().then(function() {
                        setTimeout(function() {
                            e.loadToolbar()
                        }, 3e3),
                        Promise.all([(0,
                        d.getNewuserinfo)(), (0,
                        d.getCompanyinfo)()]).then(function(e) {
                            var t = r(e, 2)
                              , n = t[0]
                              , i = t[1];
                            ...
                            seajs.use("ad_noob", function(e) {
                                ...
                                $.when.apply($, t).then(function() {
                                    ...
                                    $.each(e, function(e, t) {
                                        t.activeData && t.activeData.isTop || ("fsbg" === t.opts.id && i && (n[e].fclog = i),
                                        t.changeTo(n[e]))
                                    })
                                })
                            }))
                    ...
                    /iPad/i.test(window.navigator.userAgent)) {
                        ...
                        t.src = "//nfa.jd.com/loadFa.js?aid=2_955_8766",
                        document.body.appendChild(t)
                    }
                    !function() {
                        var e = document.createElement("script");
                        e.src = "//h5.360buyimg.com/ws_js/jdwebm.js?v=pcHome",
                ...
                function getEnjoy() {
                    if (ne) {
                        ...
                        return l["default"].createElement(s["default"], i({
                            title: "大促楼层",
                            height: ie
                        }, e), l["default"].createElement(ne, null))
                    }
                    return ""
                }
                return getEnjoy
            ...
            value: function() {
                function render() {
                    ...
                    return l["default"].createElement("div", {
                        ...
                        title: "核心场景2",
                        height: 480
                    }, this.lazyloadOptions), l["default"].createElement(P["default"], null)), t && t.map(function(t, n) {
                        ...
                        return l["default"].createElement("div", {
                            id: "J_" + t.name,
                            className: (0,
                            d.mergeClassName)("stage", "stage_" + (1 + n))
                    ...
                    }), Z ? l["default"].createElement(s["default"], i({
                        title: "JOY寻宝",
                        height: 585
                        ...
                        title: "还没逛够",
                        height: 730
                    }, this.lazyloadOptions), l["default"].createElement(G["default"], null)), l["default"].createElement(s["default"], i({
                        height: 500
                    }, this.lazyloadOptions), l["default"].createElement(Q["default"], null)))
                }
                return render
            }()
        }]),
    ...
    (0,
    y["default"])(),
    document.getElementsByClassName("focus_item").length > 1)
        n.e(16).then(n.bind(null, 130)).then(function(e) {
            e["default"]()
        });
    else {
        ee && (0,
        ...
        (0,
        k["default"])();
        var oe = "number" == typeof pageConfig.logoSectionStart ? pageConfig.logoSectionStart : -1
          , ae = pageConfig.logoSectionEnd || 0;
        8 !== document.documentMode && (p["default"].unifiedHash > oe && p["default"].unifiedHash <= ae || (0,
        d.isdebug)(23)) ? (0,
        C["default"])() : (0,
        v.sendImprPlainLogo)(),
        l["default"].render(l["default"].createElement(re, null), document.getElementById("app"))
    }
}
, function(e, t, n) {
    "use strict";
        ...
        a.loadAsync)({
            ...
            if (t && "object" === (void 0 === t ? "undefined" : r(t)) && Array.isArray(t.data)) {
                ...
                m.forEach(function(e, t) {
                    g >= 9 || y(e) && (h.push(e),
                    g++,
                    l += '<a href="' + e.u + '" target="_blank">' + e.n + "</a>")
                }),
                $("#hotwords").html(l),
                $.each($("#hotwords a"), function(t, n) {
                    ...
                    if (e && 1 !== e) {
                        var t = 0
                          ...
                          , o = function setAutoSpecHotWords(o) {
                            clearTimeout(n),
                            o && (i = f[t],
                            r.html(i.n).attr("href", i.u),
                            n = setTimeout(function() {
                                t = (t + 1) % e,
                                setAutoSpecHotWords(!0)
                            }, 3e3))
                        };
                ...
                !function() {
                    if (s.length) {
                        ...
                        _.bind("focus", function() {
                            ...
                            if (13 === e.keyCode)
                                return o() ? search("key") : search("key", r.d || r.n),
                                l(!1),
                                !1;
                            (0,
                            a.isCharacterKey)(e.keyCode) && v.html("")
                        }).bind("keyup", function() {
                            o() ? v.html("") : v.html(r.n)
                        }).removeAttr("onkeydown"),
                        b.bind("click", function(e) {
                            return i ? search("key", r.d || r.n) : search("key"),
                            l(!1),
                            !1
                        }).removeAttr("onclick"),
                        _.is(":focus") || l(!0)
...
, function(e, t) {
    ...
    window.search = function(e, t) {
        var i, r = "//search.jd.com/Search?keyword={keyword}&enc={enc}{additional}", o = search.additinal || "";
        if ("string" == typeof t && "" != t ? o += "&spm=a.0.0" : t = document.getElementById(e).value,
        t = t.replace(/^\s*(.*?)\s*$/, "$1"),
        ...
        case 5:
            ...
            case "51":
                l = d.replace(/\[cid2]/, ""),
                l = l.replace(/\{cid1}/g, "5272");
                break;
            case "52":
                l = d.replace(/\{cid1}/g, "5272"),
                l = l.replace(/\[cid2]/, "%3Bcid2%2CL{cid}M{cid}");
                break;
            case "61":
                l = d.replace(/\[cid2]/, ""),
                l = l.replace(/\{cid1}/g, "5273");
                break;
            case "62":
                l = d.replace(/\{cid1}/g, "5273"),
                l = l.replace(/\[cid2]/, "%3Bcid2%2CL{cid}M{cid}");
                break;
            case "71":
                l = d.replace(/\[cid2]/, ""),
                l = l.replace(/\{cid1}/g, "5274");
                break;
            case "72":
                l = d.replace(/\{cid1}/g, "5274"),
                l = l.replace(/\[cid2]/, "%3Bcid2%2CL{cid}M{cid}");
                break;
            case "81":
                l = d.replace(/\[cid2]/, ""),
                l = l.replace(/\{cid1}/g, "5275");
                break;
            case "82":
                l = d.replace(/\{cid1}/g, "5275"),
                l = l.replace(/\[cid2]/, "%3Bcid2%2CL{cid}M{cid}")
            }
        ...
        case 6:
            s = "-1",
            r = "//music.jd.com/8_0_desc_0_0_1_15.html?key={keyword}";
            break;
        case 7:
        ...
        if ("string" == typeof u && "" != u && (o += "&ev=" + u),
        t = encodeURIComponent(t),
        i = r.replace(/\{keyword}/, t),
        i = i.replace(/\{enc}/, "utf-8"),
        i = i.replace(/\{additional}/, o),
        ...
        if (!(t.length < 1)) {
            ...
            var r = '<a style="color:#005AA0" onclick="$o.del(event)">删除</a>'
              ...
              , g = function(e) {
                ...
                if (t += "&ver=2&zip=1&key=#{keyword}&pvid=" + p + "&t=#{time}&curr_url=" + encodeURIComponent(e.location.host + e.location.pathname),
            ...
            SearchBox.prototype.clickItem = function(e) {
                ...
                null == a || $.trim(a).isEmpty() || t.val(i.htmlspecialcharsDecode(a)),
                null !== e.getAttribute("act") && (r += e.getAttribute("act")),
                search.additinal = r,
                search("key")
            }
            ,
            SearchBox.prototype.mouseenter = function(e) {
                var e = $(e);
                e.attr("history") && e.find(".search-count").html(r),
            ...
            SearchBox.prototype.selectItemNode = function(e) {
                ...
                o.attr("history") && o.find(".search-count").html("搜索历史"),
                o.hasClass("J_shop_box") && o.find(".name").css("text-decoration", "none"),
                -1 == n.index && -1 == e && (e = 0),
                n.index = (n.length + n.index + e) % n.length;
                var a = $("#d_" + n.index)
                  , l = "&suggest=" + a.attr("suggest-pos") + "." + n.version;
                if (a.length > 0) {
                    a.attr("history") && a.find(".search-count").html(r),
                    a.hasClass("J_shop_box") ? a.find(".name").css("text-decoration", "underline") : a.css("background-color", "#FFDFC6");
                    var c = a.attr("title");
                    null == c || $.trim(c).isEmpty() || t.val(i.htmlspecialcharsDecode(c));
                    var s = a.attr("cid");
                    search.cid = null != s && "" != s ? s : null;
                    var u = a.attr("cLevel");
                    search.cLevel = null != u && "" != u ? u : null,
                    void 0 !== a.attr("act") && (l += a.attr("act")),
                    search.additinal = l
                }
            }
            ,
                    ...
                    $.ajax({
                        ...
                        success: function(t) {
                            return function(n) {
                                ...
                                h ? e.onloadGLOBALItems(n) : e.onloadItems(n))
                            }
                        }((new Date).getTime())
                    })
                }, 150)
            ...
            SearchBox.prototype.keydown_up = function(n) {
                ...
                default:
                    i.IME = 229 == o,
                    8 == o || 46 == o ? i.disableRemind() : i.enable_remind = !0,
            ...
            SearchBox.prototype.onloadGLOBALItems = function(r) {
                ...
                for (r[g - 1] && r[g - 1].version && (c.version = r[g - 1].version); h < g; h++) {
                    ...
                    if (b && (b.key || b.pcif) && (!b.pcif || 0 == iItemLen))
                        if (b.rem && c.remindKey(b.rem.rei, b.rem.req),
                        b.pcif) {
                            if (0 == f) {
                                for (var y = 0, w = b.pcif.length; y < w; y++)
                                    switch (b.pcif[y].iftp) {
                                    case "0":
                                        break;
                                    case "1":
                            ...
                            0 == iItemLen && iLen > 0 ? m += i.replace('<li class="fore1"><div id="d_#{id}" suggest-pos="#{suggest_pos}" class="fore1" title="#{title}" onclick="$o.clickItem(this)" #{history_mark}><div class="search-item" #{history_style}>#{keyword}</div><div class="search-count">#{search_count}</div></div>#{categorys}</li>', {
                                id: 0,
                                title: k,
                                keyword: j,
                ...
                c.length = ++iLen,
                "" != m ? (m += "object" == (void 0 === b ? "undefined" : n(b)) && b.his ? '<li class="close" onclick="$o.del(event)">全部删除</li>' : '<li class="close" onclick="$o.hideTip()">关闭</li>',
                d.html(m).show().find('[id^="d_"]').bind("mouseleave", function() {
                    c.mouseleave($(this))
            ...
            SearchBox.prototype.onloadItems = function(r) {
                ...
                for (r[g - 1] && r[g - 1].version && (l.version = r[g - 1].version); h < g; h++) {
                    var b = r[h];
                    if (b && (b.key || b.pcif) && (!b.pcif || 0 == iItemLen))
                        if (b.rem && l.remindKey(b.rem.rei, b.rem.req),
                        b.pcif) {
                            if (0 == f) {
                                for (var y = 0, w = b.pcif.length; y < w; y++)
                                    switch (b.pcif[y].iftp) {
                                    ...
                                    case "1":
                                        sCategoriesHtml += i.replace(c, {
                                            ...
                                            title: i.htmlspecialchars(b.pcif[y].shq),
                                            className: "item1",
                                            act_name: ' <img class="dropdown-simg" src="https://img30.360buyimg.com/uba/jfs/t23851/25/1308766769/1435/39f22c3b/5b5983e7N8824e17c.png">在全球购下搜索' + b.pcif[y].shq,
                                            act_value: "&gp=1",
                                            amount: b.pcif[y].wds,
                                            suggest_pos: p + ".wor.0"
                                        });
                                ...
                                v && (iLen = 1),
                                m += i.replace('<li class="fore1">#{categorys}</li>', {
                                    id: 0,
                                    title: k,
                                    keyword: j,
                                    suggest_pos: p++ + (b.his ? ".his.0" : ".def.0"),
            ...
            SearchBox.prototype.remindKey = function(e, n) {
                t.val() == e && this.enable_remind && (f && this.IME && /\w/.test(e.substr(-1)) || (t.val(n),
                this.keep_keyword = e,
    ...
    !function() {
                ...
                if (t)
                    try {
                        var i = t.getAttribute("id")
                          , r = /^ad\d+/gi;
                        i && !r.test(i) ? n += t.nodeName.toLowerCase() + '[id="' + t.getAttribute("id") + '"]/' : (n += t.nodeName.toLowerCase() + "[" + siblingIndex(t) + "]/",
        ...
        function getDomTreeBind(e) {
            ...
            if (!document.getElementById("tracelessLogDebug")) {
                ...
                r.style.border = "1px #C81623 solid",
                r.style.padding = "5px 10px",
                r.style.width = "900px",
                r.style.height = "20px",
                r.style.background = "#C81623",
                r.style.color = "#fff",
                r.style.zIndex = 100,
                r.style.opacity = .7,
            ...
            function sendData() {
                if (o.length > 0) {
                    for (var e = 0; e < o.length; e++)
                        o[e]["d"] = parseFloat(o[e]["d"].toFixed(2));
            ...
            function timeOutTrigger() {
                ...
                n = window.setTimeout(function() {
                    ...
                    t = window.setInterval(function() {
                        e && (!1 === document.hidden ? (a = !1,
                        0 === o.length ? (i.d = 0,
                        o.push(i)) : i.d += .01) : !1 === a && (sendData(),
                        o = [],
                        a = !0))
                    }, 10)
                }, 500)
        ...
        function getBrowserInfo(e) {
            return function(e) {
                ...
                i.version = t[1] || "0",
                o = !0),
                o && (i.versionNumber = parseInt(i.version, 10)),
                i
        ...
        if (!window.uba_lab_tag) {
                        ...
                        function success(e) {
                            e && $.each(e, function(o) {
                                var a = e[o]
                                  , l = a.url.toLowerCase()
                                  , s = (new Date).getTime();
                                if (a.url && a.startOn && a.endOn && a.percent && m(a) && s >= a.startOn && s <= a.endOn + 864e5 && r(c, 1e4) <= 100 * parseInt(a.percent))
                                    ...
                                    i.addHandler(document, "click", function(e) {
                                        ...
                                        if (o.parentNode) {
                                            var a = getDomTree(o);
                                            if (inArray(n.universal, a) || n.urls[l] && inArray(n.urls[l], a) || d(r),
                                            t[l]) {
                                                var c = inArray(t[l], a);
                                                c && p(r, c)
                                            }
            ...
            function() {
                    ...
                    function delayLoad() {
                        ...
                        if (!(t < 0 && "msie" === r.name && 9 === r.versionNumber)) {
                            ...
                            if (window.chrome && window.chrome.loadTimes) {
                                ...
                                "number" == typeof a.msFirstPaint && (n = a.msFirstPaint - l);
                            n = Math.max(0, n),
                            t = Math.max(0, t);
                            var d = {
                                dr: e,
                ...
                var e = window.performance || window.webkitPerformance || window.mozPerformance || window.msPerformance
                  ...
                  , a = null
                  , l = 0;
                h(["br=" + [r.platform, r.name, r.versionNumber].join(".")]),
                ...
                "msie" === r.name && 9 === r.versionNumber && (a = setInterval(makesureLoad, 1e3)),
                window.addEventListener("load", onload)) : h(obj2Array({
                    dr: 0,
                    lp: 0,
                    fp: 0,
                    di: 0,
    ...
    var l = {
        ...
        init: function() {
            function init() {
                ...
                e.el.find(".dropdown-layer").html('<div id="J_cart_pop"><span class="loading"></span></div>'),
                ...
                null != this.el && this.el.bind("mouseenter", function() {
                    e.FN_Refresh()
                })
            }
            return init
        ...
        FN_BindEvents: function() {
            function FN_BindEvents() {
                ...
                $("#J_cart_pop .J_delete").bind("click", function() {
                    ...
                    t && (t.length > 1 && t[1] && (r.targetId = t[1]),
                    (0,
                    o.loadAsync)({
                        url: e.URL_Serv,
                        params: r,
        ...
        FN_Refresh: function() {
            function FN_Refresh() {
                ...
                o.loadAsync)({
                    ...
                    t.Cart.getImageDomain = o.getImageDomain,
                    t.Cart.URLS = a.URLS;
                    var c = (0,
                    r["default"])(e.TPL_List.single, t.Cart)
                      , s = (0,
                    r["default"])(e.TPL_List.gift, t.Cart)
                      , u = (0,
                    r["default"])(e.TPL_List.suit, t.Cart)
                      , d = (0,
                    r["default"])(e.TPL_List.mz, t.Cart)
                      , f = (0,
                    r["default"])(e.TPL_List.mj, t.Cart);
                    l > 0 ? (n.html((0,
                    r["default"])(e.TPL_List.wrap, t.Cart)),
                    n.find(".J_cart_bd").html(c + s + u + f + d)) : n.html(e.TPL_NoGoods),
                    e.FN_BindEvents()
                }),
                e.DATA_Amount = (0,
                o.readCookie)(e.DATA_Cookie),
    ...
    var r = n(0)
      ...
      , k = function(e) {
        function Shortcut() {
            ...
            return e.props.ctn.innerHTML = "",
            e
        }
        return _inherits(Shortcut, e),
        i(Shortcut, [{
            key: "render",
            value: function() {
                function render() {
...
, function(e, t, n) {
    ...
    function longAreaNameProcess(e, t, n, i) {
        var r = "";
        if (t.name.length >= n.longerAreaSize ? r = "longer-area" : t.name.length >= n.longAreaSize && (r = "long-area"),
        i && n.className.selected || r) {
            var o = $(e);
            i && n.className.selected && o.find("a:first").addClass(n.className.selected),
            r && o.addClass(r),
            e = $("<div/>").html(o).html(),
    ...
    function bindAreaSelectEvent() {
        ...
        $("." + i.content_content, t).undelegate("a[data-id]", "click").delegate("a[data-id]", "click", function(r) {
            ...
            changeAreaByIdSeq(l, function(t) {
                n.className.selected && o.addClass(n.className.selected),
                n.selectedClose && showAreaContent.call(e, !1),
                drawSelectAreaText.call(e, t),
                $.isFunction(n.onChange) && n.onChange.call(e, o, a, t),
                n.writeCookie && writeCookie(n, t.provinceId, l),
                n.syncServer && n.writeServer && writeServer(l, t.provinceId)
            })
        }),
        $("." + i.content_content, t).undelegate("a[data-onchange=1]", "click").delegate("a[data-onchange=1]", "click", function() {
            var r = $(this);
            n.className.selected && ($("." + i.content_content + " a." + n.className.selected, t).removeClass(n.className.selected),
            r.addClass(n.className.selected)),
            n.selectedClose && showAreaContent.call(e, !1),
            $.isFunction(n.onChange) && n.onChange.call(e, r)
        })
    }
    function writeCookie(e, t, n) {
        v(e.cookieMapping.areaId, t, e.cookieOpts),
        v(e.cookieMapping.allLocal, n, e.cookieOpts)
    }
    ...
    function showAreaContent(e) {
        ...
        e ? (m > -1 && (clearTimeout(m),
        m = -1),
        offsetBoxLeft.call(t),
        t.el.addClass(n),
        m = setTimeout(function() {
            t.el.addClass(n)
        }, 1)) : (m > -1 && (clearTimeout(m),
        m = -1),
        t.el.removeClass(n))
    }
    ...
    function saveSelectedLocal(e, t, n) {
        ...
        return i = i && i.split("-") || [0, 0, 0, 0],
        "object" === (void 0 === t ? "undefined" : r(t)) ? i = convertAreaIdList(t) : (i = h.city[t]) && (i = (i + "-0").split("-")),
        i = i.join("-"),
        e.data("select-local", i),
        i
    }
    function drawSelectAreaContent(e, t) {
        var n = this
          ...
          , o = r.tplContentWrap
          , a = r.tplContentItem;
        $(n.css.content_content).html(renderProvinceList.call(n, o, a, 0, e)),
        -1 == t && saveSelectedLocal(i, e),
        bindAreaSelectEvent.call(n, r)
    }
      ...
      , _ = function(e) {
        function HeadAreamini() {
            ...
            for (var r = arguments.length, o = Array(r), a = 0; a < r; a++)
                o[a] = arguments[a];
            return t = n = _possibleConstructorReturn(this, (e = HeadAreamini.__proto__ || Object.getPrototypeOf(HeadAreamini)).call.apply(e, [this].concat(o))),
            n.defaultOptions = {
                hasCssLink: !0,
                baseVersion: "1.0.0",
            ...
            n.css = {},
            i = t,
            _possibleConstructorReturn(n, i)
        }
        return _inherits(HeadAreamini, e),
        i(HeadAreamini, [{
            key: "shouldComponentUpdate",
            value: function() {
                function shouldComponentUpdate() {
            ...
            value: function() {
                function init(e, t) {
                    ...
                    n.el = e,
                    n.options = (0,
                    o.merge)({}, this.defaultOptions, t);
                    var i = n.options
                      , r = n.el;
                    i.scopeLevel = 1,
                    n.css = transformClassName("#" + r[0].id, i.className),
                    i.provinceList && i.provinceExtend && (i.provinceList = $.extend(!0, [], getProvinceList().concat(i.provinceList))),
                    loadLocal(i, function(e) {
                        drawSelectAreaText.call(n, e),
                        drawSelectAreaContent.call(n, e, -1);
                        var t = "hover" == i.event ? "mouseenter" : "click";
                        $(n.css.text).bind(t, function() {
                            return showAreaContent.call(n, !0),
                            !1
                        }),
                        ...
                        onReady: function() {
                            function onReady(e) {
                                ...
                                if (c["default"].check() && t) {
                                    var n = "areaId";
                                    c["default"].get(n) ? c["default"].get(n) !== t && (c["default"].set(n, t),
                                    c["default"].clearByReg("^jd_home_2015_")) : c["default"].set(n, t)
                                }
    ...
    var l = function(e) {
        function ShortcutCompany() {
            ...
            for (var r = arguments.length, o = Array(r), l = 0; l < r; l++)
                o[l] = arguments[l];
            return t = n = _possibleConstructorReturn(this, (e = ShortcutCompany.__proto__ || Object.getPrototypeOf(ShortcutCompany)).call.apply(e, [this].concat(o))),
            n.enterStamp = null,
            n.poi = "head|topbar_company",
            n.onMouseenter = function() {
                n.enterStamp = Date.now()
            }
            ,
            n.onMouseleave = function() {
                !n.enterStamp || Date.now() - n.enterStamp < 1e3 || (n.enterStamp = null,
                (0,
                a.logImpr)({
                    poi: n.poi
                }))
        ...
        return _inherits(ShortcutCompany, e),
        i(ShortcutCompany, [{
            key: "getDropdown",
            value: function() {
    ...
    var i = function() {
      ...
      , c = function(e) {
        function ShortcutMember() {
            ...
            for (var r = arguments.length, o = Array(r), a = 0; a < r; a++)
                o[a] = arguments[a];
            return t = n = _possibleConstructorReturn(this, (e = ShortcutMember.__proto__ || Object.getPrototypeOf(ShortcutMember)).call.apply(e, [this].concat(o))),
            n.state = {
                isCompany: !1
            },
            i = t,
        ...
        return _inherits(ShortcutMember, e),
        i(ShortcutMember, [{
            key: "componentDidMount",
            value: function() {
                function componentDidMount() {
                    var e = this;
                    (0,
                    a.getCompanyinfo)().then(function(t) {
                        var n = t.isCompany;
                        e.setState({
                            isCompany: n
                        })
    ...
    var i = n(0)
      ...
      , l = function() {
        var e = this
          ...
          , i = function() {
            n = Date.now(),
            e.$mobile.addClass("mobile_on"),
            t || (t = !0,
            (0,
            o.loadLegacy)().then(function() {
          ...
          , l = function() {
            clearTimeout(null),
            e.$mobile.removeClass("mobile_on"),
            Date.now() - n < 1e3 || (0,
            a.logImpr)({
...
, function(e, t, n) {
    ...
    l["default"])({
        loader: function() {
            function loader() {
                return n.e(19).then(n.bind(null, 111))
            }
            return loader
        }(),
        loading: function() {
            function loading(e) {
                return e.pastDelay ? o["default"].createElement("div", null) : (e.err,
      ...
      , u = function(e) {
        function ShortcutNerv() {
            ...
            return e.onMouseenter = function() {
                ...
                e.state.renderDropdown || e.setState({
                    renderDropdown: !0
                })
            }
            ,
            e.onMouseleave = function() {
                !e.enterStamp || Date.now() - e.enterStamp < 1e3 || (e.enterStamp = null,
                (0,
                c.logImpr)({
        ...
        return _inherits(ShortcutNerv, e),
        i(ShortcutNerv, [{
            key: "getDropdown",
            value: function() {
                function getDropdown() {
...
, function(e, t, n) {
    ...
    var r = n(0)
      ...
      , s = function(e) {
        ...
        return _inherits(shortService, e),
        i(shortService, [{
            key: "processData",
            value: function() {
                function processData(e) {
...
, function(e, t, n) {
    ...
    var o = n(0)
      ...
      , u = function(e) {
        ...
        return _inherits(shortcutSitenav, e),
        r(shortcutSitenav, [{
            key: "requestData",
            value: function() {
                function requestData() {
...
, function(e, t, n) {
    ...
    f["default"])({
        loader: function() {
            function loader() {
                return n.e(18).then(n.bind(null, 112))
            }
            return loader
        }(),
        loading: function() {
            function loading(e) {
                return e.pastDelay ? a["default"].createElement("div", null) : (e.err,
      ...
      , m = function(e) {
        ...
        return _inherits(ShortcutUserinfo, e),
        r(ShortcutUserinfo, [{
            key: "requestUsername",
            value: function() {
            ...
            value: function() {
                function componentDidMount() {
                    var e = this;
                    Promise.all([this.requestUsername(), this.requestUserinfo(), (0,
                    l.getCompanyinfo)()]).then(function(t) {
                        var n = i(t, 3)
                          , r = n[0]
                          , o = n[1]
                          , a = n[2].isCompany;
                        r.nick ? (e.ssoList = r.sso,
                        e.setState({
                            nick: r.nick,
            ...
            value: function() {
                function render() {
                    ...
                    return t ? a["default"].createElement("li", {
                        id: "ttbar-login",
                        className: (0,
                        l.mergeClassName)("shortcut_btn", "fore1", "dropdown", "shortcut_userico" + n, i ? "shortcut_userico_company" : ""),
...
, function(e, t, n) {
    ...
    t["default"] = function() {
        ...
        r["default"].render(r["default"].createElement(u["default"], null), document.getElementById("J_rec")),
        $("#J_user").removeClass("mod_loading"),
        r["default"].render(r["default"].createElement(f["default"], null), document.getElementById("J_user")),
        y.CONSTS.showNews) {
            var t = document.getElementById("J_news");
            t.innerHTML = "",
            r["default"].render(r["default"].createElement(m["default"], null), t)
        } else
            $(".J_news_tab").css({
                display: "block"
            }),
    ...
    var l = n(4)
      ...
      , p = function(e) {
        function Focus() {
            ...
            e.clstagPrefix = l.CONSTS.CLSTAGPREFIX,
            e.poi = "head|focus",
            e.imgList = [],
            e.logSl = function() {
                (0,
            ...
            e.customIndicator = function(t) {
                return a["default"].createElement("i", {
                    clstag: e.clstagPrefix + "|" + e.poi + "_s" + (0,
                    s.padding)(1 + t, 2),
                    onClick: function() {
                        function onClick() {
                            (0,
            ...
            e.beforeChange = function(t, n) {
                ...
                e.loadImg((n + 1) % i),
                e.sendClog(n, t),
                e.imprMap[n] || (e.sendImpr(n),
                e.imprMap[n] = !0)
            }
            ;
            var t = void 0;
            return t = pageConfig.focusData && pageConfig.focusData.length ? [pageConfig.focusData[0]] : [],
            e.props.ctn.innerHTML = "",
            e.state = {
            ...
            value: function() {
                function processData(e) {
                    ...
                    e.map(function(e, n) {
                        ...
                        s.getRandomData)(e)
                          , o = r.ext_columns || {};
                        return pageConfig.clog.logDomain = pageConfig.clog.logDomain || e.logDomain,
                        pageConfig.clog.logV = pageConfig.clog.logV || e.logV,
                        r.img = 0 === n ? r.src : (0,
                        s.processImage)(r.src, {
            ...
            value: function() {
                function requestData() {
                    ...
                    s.loadAsync)({
                        ...
                        dataCheck: function() {
                            function dataCheck(e) {
                                if (e.data && $.isArray(e.data) && e.data.length >= 7)
                                    return !0
                            }
                            return dataCheck
                        }()
            ...
            value: function() {
                function getSliderItem(e, t) {
                    var n = this
                      ...
                      , o = Boolean(e.clog);
                    return o && -1 !== [2, 3, 5].indexOf(t + 1) && (o = "1" === e.sourceTag),
                    a["default"].createElement("li", {
                        className: "focus_item"
                    }, a["default"].createElement("a", {
                        href: e.href,
                        className: "focus_item_lk",
                        clstag: this.clstagPrefix + "|" + this.poi + "_" + (0,
                        s.padding)(1 + t, 2),
                        target: "_blank",
                        onClick: function() {
                            function onClick() {
                                (0,
                                u.logClick)(i({}, e.extColumns, {
                                    comment: "首焦"
                                }))
                            }
                            return onClick
            ...
            value: function() {
                function processData(e) {
                    ...
                    return e.map(function(e, n) {
                        ...
                        d.getRandomData)(e) : e
                          , o = r.ext_columns || {};
                        return r.url = r.t.replace(/^http(s?):/, ""),
                        r.imgUrl = (0,
                        d.processImage)(r.img, {
                        ...
                        d.isInternational && 0 === n && (r.extColumns.poi = t.poi + "_04"),
                        r
                    })
                }
                return processData
            ...
            value: function() {
                function getData() {
                    var e = this
                      , t = []
                      , n = void 0;
                    pageConfig.recData && Array.isArray(pageConfig.recData.data) && (t = pageConfig.recData.data,
                    n = pageConfig.recData.impr);
                    var i = [];
            ...
            value: function() {
                function getRecItems() {
                    ...
                    return e.map(function(e, i) {
                        var r = t + "|" + n + "_" + (0,
                        d.padding)(1 + i, 2);
                        return d.isInternational && (r = t + "|" + n + "_04"),
                        a["default"].createElement("div", {
                            className: "rec_item",
                            ref: function() {
                                function ref(t) {
...
, function(e, t, n) {
    ...
    var i = n(0)
      ...
      , a = function(e) {
        ...
        d = r["default"].createElement("p", null, r["default"].createElement("a", {
...
, function(e, t, n) {
    ...
    var h = function(e) {
        function Logo() {
            ...
            for (var o = arguments.length, l = Array(o), d = 0; d < o; d++)
                l[d] = arguments[d];
            return t = n = _possibleConstructorReturn(this, (e = Logo.__proto__ || Object.getPrototypeOf(Logo)).call.apply(e, [this].concat(l))),
            n.poiPrefix = "head|logo",
            n.domInfo = {},
            n.showState = !1,
            n.showLimit = 2,
            n.isAnimating = !1,
            n.animationDuration = 5200,
            n.replayTimer = null,
            n.hideTimer = null,
            n.showTextTimer = null,
            n.showTextStamp = 2600,
            n.shouldStopCycling = !0,
            n.showCount = 0,
            n.isInterruptable = !1,
            n.imageDom = null,
            n.enterStamp = null,
            ...
            n.processData = function(e) {
                ...
                return -1 === t.joy_word.indexOf("$") && (n.isOld = !0,
                n.animationDuration = 4200),
                Promise.resolve(h)
            }
            ,
            n.shouldFadeout = !1,
            ...
            c.throttle)(function() {
                ...
                e !== n.showState && (n.showState = e,
                n.showState && (n.showCount >= n.showLimit || n.ensureIdle(function() {
                    n.isInterruptable = !1,
                    n.isHover = !1,
                    n.startAnimateLogo()
                })))
            ...
            n.onLogoMouseenter = function() {
                n.shouldStopCycling = !1,
                n.isHover = !0,
                n.enterStamp = Date.now(),
                n.isAnimating || (n.isHovered = !0),
                n.ensureIdle(function() {
            ...
            n.onLogoMouseleave = function() {
                n.shouldStopCycling = !0,
                n.shouldFadeout && (n.shouldFadeout = !1,
                n.fadeOut()),
                n.isOld && n.isInterruptable && (n.replayTimer && clearTimeout(n.replayTimer),
                n.showTextTimer && clearTimeout(n.showTextTimer),
                n.shouldStopCycling = !0,
                n.fadeOut()),
                n.enterStamp && (0,
                s.logImpr)(n.getRealLogObj()),
                n.enterStamp = null
            }
            ,
        ...
        o(Logo, [{
            ...
            value: function() {
                function requestData() {
                    ...
                    if ((0,
                    c.isdebug)(21))
                        e = n.e(21).then(n.bind(null, 116)).then(function(e) {
                            return e["default"]
                        });
                    else {
                        var t = {
            ...
            value: function() {
                function getRealLogObj() {
                    var e = Object.assign({}, this.logObj)
                      , t = e.desc;
                    return e.desc = this.isHover ? t + "#hover-" + (Date.now() - this.enterStamp) : t + "#exposal",
                    e
                }
            ...
            value: function() {
                function startAnimateLogo() {
                    var e = this
                      ...
                      , l = void 0;
                    this.isHover && this.lastImage ? l = this.lastImage : (l = this.requestData().then(this.verifyData),
                    this.lastImage = l),
                    function() {
                        function requestAnimation() {
                            e.isAnimating && l.then(e.processData).then(e.loadImage).then(function(t) {
                                var l = t.imgUrl
                                  ...
                                  , h = t.clkUrl
                                  , g = t.extColumns;
                                e.isAnimating && (e.hideTimer && clearTimeout(e.hideTimer),
                                e.logObj = i({}, g, {
                                ...
                                e.sceneDom.className = "logo_scene " + r,
                                e.sceneDom.offsetWidth,
                                e.sceneDom.className = "logo_scene " + a + " " + r + " " + o,
                                e.isHover || e.showCount++,
                                e.imageDom.style.backgroundImage = "url(" + l + ")",
                                e.showTextTimer && clearTimeout(e.showTextTimer),
                                e.showTextTimer = setTimeout(function() {
                                    if (n && (e.sceneDom.className = "logo_scene " + a + " " + r),
                                    e.isHovered) {
                                        var t = i({}, e.logObj, {
                                ...
                                e.replayTimer && clearTimeout(e.replayTimer),
                                e.replayTimer = setTimeout(function() {
                                    e.isInterruptable = !0,
                                    e.shouldStopCycling ? e.fadeOut() : (e.shouldFadeout = !0,
                                    e.isOld && requestAnimation())
                                }, e.animationDuration),
                                e.sendLog(m),
                                e.sendImpl(),
                                e.isHover || (0,
                                s.logImpr)(e.getRealLogObj()),
                                e.setState({
                                    url: c,
                                    text: u,
                                    color: d,
                                ...
                                e.replayTimer && clearTimeout(e.replayTimer),
                                e.showTextTimer && clearTimeout(e.showTextTimer),
                                e.hideTimer && clearTimeout(e.hideTimer),
                                c.dconsole.log(t)
                            })
                        }
            ...
            value: function() {
                function fadeOut() {
                    var e = this;
                    this.isAnimating = !1,
                    this.sceneDom.className = "logo_scene logo_scene_fade",
                    this.sceneDom.offsetWidth,
                    this.hideTimer && clearTimeout(this.hideTimer),
                    this.hideTimer = setTimeout(function() {
                        e.isHovered = !1,
                        e.sceneDom.className = "logo_scene logo_scene_hide",
                        e.sceneDom.offsetWidth
                    }, 800)
                }
                return fadeOut
            ...
            value: function() {
                function componentDidMount() {
                    this.domInfo = (0,
                    c.getDomInfo)(l["default"].findDOMNode(this)),
                    window.addEventListener("scroll", this.onScroll),
                    this.onScroll()
                }
                return componentDidMount
...
, function(e, t, n) {
    ...
    r["default"])({
        loader: function() {
            function loader() {
                return n.e(9).then(n.bind(null, 117))
            }
            return loader
        }(),
...
, function(e, t, n) {
    ...
    r["default"])({
        loader: function() {
            function loader() {
                return n.e(0).then(n.bind(null, 118))
            }
            return loader
        }(),
        loading: o.loadingPlaceholder.bind(null, {
...
, function(e, t, n) {
    ...
    r["default"])({
        loader: function() {
            function loader() {
                return n.e(12).then(n.bind(null, 120))
            }
            return loader
        }(),
        loading: o.loadingPlaceholder.bind(null),
...
, function(e, t, n) {
    ...
    r["default"])({
        loader: function() {
            function loader() {
                return n.e(8).then(n.bind(null, 121))
            }
            return loader
        }(),
        loading: o.loadingPlaceholder.bind(null, {
...
, function(e, t, n) {
    ...
    r["default"])({
        loader: function() {
            function loader() {
                return n.e(2).then(n.bind(null, 122))
            }
            return loader
        }(),
        loading: o.loadingPlaceholder.bind(null, {
...
, function(e, t, n) {
    ...
    r["default"])({
        loader: function() {
            function loader() {
                return n.e(14).then(n.bind(null, 108))
            }
            return loader
        }(),
        loading: o.loadingPlaceholder.bind(null, {
...
, function(e, t, n) {
    ...
    r["default"])({
        loader: function() {
            function loader() {
                return n.e(7).then(n.bind(null, 123))
            }
            return loader
        }(),
        loading: o.loadingPlaceholder.bind(null, {
...
, function(e, t, n) {
    ...
    r["default"])({
        loader: function() {
            function loader() {
                return n.e(6).then(n.bind(null, 124))
            }
            return loader
        }(),
        loading: o.loadingPlaceholder.bind(null, {
...
, function(e, t, n) {
    ...
    t["default"] = function(e) {
        ...
        r["default"])({
            loader: function() {
                function loader() {
                    return n.e(10).then(n.bind(null, 126))
                }
                return loader
            }(),
            loading: o.loadingPlaceholder.bind(null, {
...
, function(e, t, n) {
    ...
    r["default"])({
        loader: function() {
            function loader() {
                return n.e(4).then(n.bind(null, 127))
            }
            return loader
        }(),
        loading: o.loadingPlaceholder.bind(null, {
...
, function(e, t, n) {
    ...
    r["default"])({
        loader: function() {
            function loader() {
                return n.e(11).then(n.bind(null, 128))
            }
            return loader
        }(),
        loading: o.loadingPlaceholder.bind(null, {
...
, function(e, t, n) {
    ...
    a["default"])({
        loader: function() {
            function loader() {
                return n.e(13).then(n.bind(null, 129))
            }
            return loader
        }(),
        loading: function() {
